//
//  Baby_KnowledgeViewController.m
//  BabyT
//
...
@interface Baby_KnowledgeViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSArray * _audioArray;
    AFSoundQueue *_queue;
}
...
@implementation Baby_KnowledgeViewController

- (void)viewWillAppear:(BOOL)animated
{
    [super viewWillAppear:animated];
    [self setTabbarTitle:@"知识库"];
    [self audioRequest];
}
